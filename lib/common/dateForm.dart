...
class DateForm{
  ...
  static String getYDayStamp(String dateString) {
    ...
    return "${DateFormat('yyyy.MM.dd').format(dateStamp)}";
  }

  static String getYMonthDay(String dateString) {
    if(dateString.length<8) {
      return dateString;
    }

    String temp = "${dateString.substring(0,4)}."
    ...
    DateTime dateStamp = DateFormat('yyyy.MM.dd').parse(temp);
    return "${DateFormat('yyyy.MM.dd').format(dateStamp)}";
  }
  ...
  static String cvtDateStamp(String dateString) {
    ...
    //return "";
    DateTime dateStamp = DateFormat('yyyy.M.d hh:mm:ss').parse(dateString);
    return "${DateFormat("yyyy.MM.dd hh:mm:ss").format(dateStamp)}";
  }
